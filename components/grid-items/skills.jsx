  ...
  return (
    <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 w-full gap-2 items-center mt-4 p-2">
      {skills.map((item, index) => (
        <div
          key={index}
          className="bg-zinc-900/90 hover:bg-zinc-200/20 hover:scale-[1.03] p-2 px-4 shadow-lg hover:shadow-xl transition-all duration-200 rounded-lg w-11/12 mx-auto"
        >
